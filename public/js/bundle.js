...
var showAlert = function showAlert(type, msg) {
  ...
  document.querySelector('body').insertAdjacentHTML('afterbegin', markup); // window.setTimeout(hideAlert, 50000);
};
...
var logOutBtn = document.querySelector('.btn--logout'); // VALUES
