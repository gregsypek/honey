      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'Problem z zalogowaniem! Spróbuj ponownie!');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type === 'password' ? 'HASŁA' : 'DANE', " zosta\u0142y zaktualizowane")); // window.setTimeout(() => {
              //   location.assign('/');
              // }, 1500);
            }
...
var stripe = Stripe('pk_test_51JL4VfG3f1SLopx1PFEzEXjf1pDNQ0ogHoLFzbcXAI82IWlibuuXzSKrvpgYiI6yYwTangKU9BnHVm4dN22SjdgB00T5lUTN2m');

var bookHoney = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(honeyId) {
    var session;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("https://127.0.0.1:3001/api/v1/bookings/checkout-session/".concat(honeyId));
  ...
  return function bookHoney(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.bookHoney = bookHoney;
...
//DOM ELEMENTS
var loginForm = document.querySelector('.contact--login');
var logOutBtn = document.querySelector('.btn--logout');
var userDataForm = document.querySelector('.form__account');
var userPasswordForm = document.querySelector('.form__password');
var bookBtn = document.getElementById('book-honey');
var images = document.querySelectorAll('.lazyload'); // VALUES
...
if (bookBtn) bookBtn.addEventListener('click', function (e) {
  ...
  var honeyId = e.target.dataset.honeyId;
  (0, _stripe.bookHoney)(honeyId);
});
